...
var outputPath = Path.Combine(Directory.GetCurrentDirectory(), $"Resident_Template_{DateTime.Now:yyyyMMddHHmmss}.xlsx");

Console.WriteLine("Generating Resident Excel Template...");
